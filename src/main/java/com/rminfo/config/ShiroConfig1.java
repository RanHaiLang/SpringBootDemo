package com.rminfo.config;

import com.rminfo.realm.AuthRealm;
import com.rminfo.util.SysConstant;
...
//        sessionDAO.setActiveSessionsCacheName("dbshiro-activeSessionCache");
...
//        cacheManager.setCacheManagerConfigFile("classpath:config/dbshiro-ehcache.xml");
