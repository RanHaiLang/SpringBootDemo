    ...
    d.fn.tableExport = function (l) {
            ...
            c.each(function () {
                if (d(this).is("div")) {
                    var c = ba(K(this, "background-color"), [255, 255, 255]),
                        ...
                        y = this.getBoundingClientRect(), q = this.offsetLeft * f.dw, e = this.offsetTop * f.dh,
                        l = y.width * f.dw;
                    y = y.height * f.dh;
        ...
        function va(b, c, f) {
            if ("function" === typeof f.onAutotableText) f.onAutotableText(f.doc, b, c); else {
                var h = b.textPos.x, g = b.textPos.y, k = {halign: b.styles.halign, valign: b.styles.valign};
                if (c.length) {
                    for (c =
                             c[0]; c.previousSibling;) c = c.previousSibling;
                    for (var y = !1, q = !1; c;) {
        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            d(t).each(function () {
                var b = [];
                D(this, "th,td", n, t.length, function (c, f, h) {
                    if ("undefined" !== typeof c && null !== c) {
                        ...
                        "function" !== typeof a.onCellData && "" !== h && h === +h && (h = +h);
                        b.push("" !== h ? h : null);
            ...
            d(v).filter(function () {
                ...
                d(r).each(function () {
                    p = "";
                    D(this, "th,td", n, r.length, function (b, f, h) {
                        if (null !== b) {
                            var c = "";
                            p += "<th";
                            for (var k in a.mso.styles) if (a.mso.styles.hasOwnProperty(k)) {
                                var e = d(b).css(a.mso.styles[k]);
                                "" !== e && "0px none rgb(0, 0, 0)" !== e && "rgba(0, 0, 0, 0)" !== e && (c += "" === c ? 'style="' : ";", c += a.mso.styles[k] + ":" + e)
                            }
                            "" !== c && (p += " " + c + '"');
                            c = S(b);
                            0 < c && (p += ' colspan="' +
                ...
                d(t).each(function () {
                    ...
                    D(this, "td,th", n, r.length + t.length, function (c, e, g) {
                        if (null !== c) {
                            var k = B(c, e, g), h = "", f = d(c).data("tableexport-msonumberformat");
                            "undefined" === typeof f && "function" === typeof a.mso.onMsoNumberFormat && (f = a.mso.onMsoNumberFormat(c, e, g));
                            "undefined" !== typeof f && "" !== f && (h = "style=\"mso-number-format:'" + f + "'");
                            for (var l in a.mso.styles) a.mso.styles.hasOwnProperty(l) &&
                            (f = d(c).css(a.mso.styles[l]), "" === f && (f = b.css(a.mso.styles[l])), "" !== f && "0px none rgb(0, 0, 0)" !== f && "rgba(0, 0, 0, 0)" !== f && (h += "" === h ? 'style="' : ";", h += a.mso.styles[l] + ":" + f));
                            p += "<td";
                            "" !== h && (p += " " + h + '"');
                            e = S(c);
                            0 < e && (p += ' colspan="' + e + '"');
                ...
                d(a).each(function () {
                    ...
                    D(this, c, n, e, function (b, d, c) {
                        if ("undefined" !== typeof b && null !== b) {
                            var g = S(b), k = T(b);
                            b = B(b, d, c) || " ";
                            1 < g || 1 < k ? a.push({colSpan: g || 1, rowSpan: k || 1, text: b}) : a.push(b)
                        } else a.push(" ")
                    });
                    a.length && Ba.push(a);
            ...
            if (null == e.doc && (e.doc = new jsPDF(a.jspdf.orientation, a.jspdf.unit, a.jspdf.format), "function" === typeof a.jspdf.onDocCreated)) a.jspdf.onDocCreated(e.doc);
            ...
            "undefined" !== typeof e.images && (d(v).filter(function () {
                ...
                var b = 0;
                F = [];
                !1 === a.exportHiddenCells && (I = d(this).find("tr, th, td").filter(":hidden"),
                    U = 0 < I.length);
                r = u(d(this));
                t = w(d(this));
                d(t).each(function () {
            ...
            Ga(e, function () {
                d(v).filter(function () {
                    ...
                    "function" !== typeof c.createdHeaderCell && (c.createdHeaderCell = function (a, b) {
                        ...
                        if ("undefined" !== typeof e.columns[b.column.dataKey]) {
                            ...
                            a.styles.halign =
                                "inherit" === c.headerStyles.halign ? "center" : c.headerStyles.halign;
                    ...
                    "function" !== typeof c.createdCell && (c.createdCell = function (a, b) {
                        b = e.teCells[b.row.index +
                        ":" + b.column.dataKey];
                        a.styles.halign = "inherit" === c.styles.halign ? "center" : c.styles.halign;
                        a.styles.valign = c.styles.valign;
                        "undefined" !== typeof b && "undefined" !== typeof b.style && !0 !== b.style.hidden && ("inherit" === c.styles.halign && (a.styles.halign = b.style.align), "inherit" === c.styles.fillColor && (a.styles.fillColor = b.style.bcolor), "inherit" === c.styles.textColor && (a.styles.textColor = b.style.color), "inherit" === c.styles.fontStyle && (a.styles.fontStyle = b.style.fstyle))
                    });
                    ...
                    "function" !== typeof c.drawCell && (c.drawCell = function (a, b) {
                        ...
                        if (!0 !== ("undefined" !== typeof c && c.isCanvas)) {
                            if (ra(a, b, c)) if (e.doc.rect(a.x, a.y, a.width, a.height, a.styles.fillStyle), "undefined" !== typeof c && "undefined" !== typeof c.elements && c.elements.length) {
                                b = a.height / c.rect.height;
                                if (b > e.dh ||
                                    "undefined" === typeof e.dh) e.dh = b;
                            ...
                            c = c.elements[0];
                            b = d(c).attr("data-tableexport-canvas");
                    ...
                    if (0 < n) for (var f =
                        n - 1; 0 <= f;) d.each(e.headerrows[f], function () {
                        var a = this;
                    ...
                    d(t).each(function () {
                        ...
                        D(this, "td,th", n, r.length + t.length, function (c, f, g) {
                            ...
                            "undefined" !== typeof c && null !== c ? (k = xa(c), k.isCanvas =
                                c.hasAttribute("data-tableexport-canvas"), k.elements = k.isCanvas ? d(c) : d(c).children()) : (k = d.extend(!0, {}, e.teCells[h + ":" + (b - 1)]), k.colspan = -1);
                            e.teCells[h + ":" + b++] = k;
                            a.push(B(c, f, g))
                        });
                ...
                qa(e.doc, "undefined" !==
                    typeof e.images && !1 === jQuery.isEmptyObject(e.images));
